      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Student Add Admision</span></li>
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Subjects</span></li>
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Student Result</span></li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Results</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('result.create') }}" class="menu-link">
                    <div data-i18n="Without menu">Add Result</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('result.index') }}" class="menu-link">
                    <div data-i18n="Without navbar">All Results</div>
                  </a>
                </li>
              </ul>
            </li>
