...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Students /</span> Update Student</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="fathers_name" value="{{ $student->fathers_name }}" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="mothers_name" value="{{ $student->mothers_name }}" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="address" value="{{ $student->address }}" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="session_year" value="{{ $student->session_year }}" type="text"
                                                class="form-control @error('session_year') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <select name="student_type"
                                                class="form-select @error('student_type') is-invalid @enderror">
                                                <option value="">Choose One</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="birthday_date" value="{{ $student->birthday_date }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="birthday_certificate_no"
                                                value="{{ $student->birthday_certificate_no }}" type="number"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="phone_number" value="{{ $student->phone_number }}" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input name="guardians_phone_number"
                                                value="{{ $student->guardians_phone_number }}" type="text"
